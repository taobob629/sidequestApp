...
class _MyHomePageState extends State<MyHomePage> {
  ...
  initTIMUIKIT() async {
    ...
    String usersig = GenerateTestUserSig(sdkappid: sdkappid, key: secret).genSig(identifier: userid, expire: 24 * 7 * 60 * 60 * 1000);
    ...
    V2TimCallback res = await timCoreInstance.login(userID: userid, userSig: usersig);
