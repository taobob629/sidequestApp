...
class TIMUIKitChatExample extends StatelessWidget {
  ...
  const TIMUIKitChatExample({Key? key, this.selectedConversation}) : super(key: key);
              ...
              onPressed: () async {
                ...
                if (conversationType == 1) {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => Scaffold(appBar: AppBar(title: Text(userID ?? "User Profile")), body: TIMUIKitProfileExample(userID: userID)),
                      ));
                } else {
