  ...
  Widget tuiBuild(BuildContext context, TUIKitBuildValue value) {
    ...
    return TIMUIKitChatProviderScope(
        ...
        builder: (context, model, w) {
          ...
          if (needUpdate != null && needUpdate.groupID == _getConvID()) {
          ...
          final alignBox = alignKey.currentContext?.findRenderObject() as RenderBox?;
          final alignHeight = alignBox?.size.height ?? 0;

          final listContainerBox = listContainerKey.currentContext?.findRenderObject() as RenderBox?;
                        ...
                        child: Align(
                            ...
                            child: Listener(
                              ...
                              child: TIMUIKitHistoryMessageListContainer(
                                ...
                                isAllowScroll: (!(listContainerBoxHeight < alignHeight)),
