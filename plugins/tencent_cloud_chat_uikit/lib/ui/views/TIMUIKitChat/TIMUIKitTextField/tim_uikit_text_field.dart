...
class TIMUIKitInputTextField extends StatefulWidget {
  ...
  final Widget Function(
      ...
      List<CustomEmojiFaceData> defaultCustomEmojiStickerList})? customStickerPanel;
      ...
      return widget.customStickerPanel != null
          ? widget.customStickerPanel!(
              ...
              addCustomEmojiText: ((String singleEmojiName) {
                ...
                if (widget.isUseDefaultEmoji && languageType == 'zh' && ConstData.emojiMapList[emojiName] != null && ConstData.emojiMapList[emojiName] != '') {
              ...
              defaultCustomEmojiStickerList: widget.isUseDefaultEmoji ? ConstData.emojiList : [])
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          if (forbiddenText == null)
                            Expanded(
                              child: showSendSoundText
                                  ? SendSoundMessage(onDownBottom: goDownBottom, conversationID: widget.conversationID, conversationType: widget.conversationType)
                                  : KeyboardVisibility(
                          ...
                          if (widget.showMorePanel && forbiddenText == null && showMoreButton)
                            InkWell(
                              onTap: () {
