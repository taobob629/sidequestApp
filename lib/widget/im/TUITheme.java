class TUITheme {
  const TUITheme({
    ...
    /// 聊天页导航栏背景颜色
    this.chatHeaderBgColor = Colors.white, // 1

    /// 聊天页导航栏Title字体颜色
    this.chatHeaderTitleTextColor = Colors.black, // 1

    /// 聊天页导航栏Back字体颜色
    this.chatHeaderBackTextColor = Colors.black, // 1

    /// 聊天页导航栏Action字体颜色
    this.chatHeaderActionTextColor = Colors.black, // 1

    /// 聊天页历史消息列表字体颜色
    this.chatMessageItemTextColor = Colors.black, // 1

    /// 聊天页历史消息列表来自自己时背景颜色
    this.chatMessageItemFromSelfBgColor = const Color(0xFFAEA4A3),
