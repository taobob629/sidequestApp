const Map<String, String> en_US = {
  ...
  'Sign in with your SideQuest ID or email.': 'Sign in with your SideQuest ID or email.',
  'SideQuest ID / Email': 'SideQuest ID / Email',
  'Enter your ID or email': 'Enter your ID or email',
  'Enter your password': 'Enter your password',
  'Forgot password?': 'Forgot password?',
  'New to SideQuest?': 'New to SideQuest?',
  ...
  'Input your Current pin': 'Input your current pin',
  ...
  "SideKicker Introduction":"SideKicker Introduction",
  ...
  "Enter group name": "Enter the group name",
  "Group introduction": "Group introduction",
  '清空聊天消息':'Clear all messages',
  '群成员':'Group member',
  '修改群名称':'Modify nickname',
  '群主、管理员':'Manager&Administrator',
  '群公告':'Notification',
  '暂无群公告':'No Notification',
  '设置管理员':'Set up the administrator',
  '群管理':'Group Administration',
  '全员禁言':'全员禁言',
  '全员禁言开启后，只允许群主和管理员发言。':'全员禁言开启后，只允许群主和管理员发言。',
  '全员禁言中':'全员禁言中',
  '添加需要禁言的群成员':'添加需要禁言的群成员',
  '置顶聊天':'Pin to top',
  '消息免打扰':'Mute',
  '我的群昵称':'Nickname',
  '修改我的群昵称':'Modify my group nickname',
  '仅限中文、字母、数字和下划线，2-20个字':'Letters, numbers, and underline(2-20 words only)',
  '清空聊天记录':'Empty the chat record',
  '转让群主':'Transfer group administrator',
  '解散该群':'Disband the group',
  '解散后不会接收到此群聊消息':'Will not receive this group chat message after the dissolution',
};
