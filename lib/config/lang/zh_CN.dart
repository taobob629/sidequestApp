const Map<String, String> zh_CN = {
  ...
  'Congratulations!': '恭喜!',
  'Your room is reserved. An confirmation email will send to you shortly.':
      '您的房间已预订。确认电子邮件将很快发送给您.',
  'We will charge a deposit of': 'We will charge a deposit of',
  'from your balance for booking this area, Please make sure that you have enough balance.':
      'from your balance for booking this area, Please make sure that you have enough balance.',
  'My Bill': '我的账单',
  'Gaming': '上网',
  'Product': '商品',
  ...
  "The coin will be refunded to your balance once the player agrees. If the player rejects your refund, you can ask for official help.":
