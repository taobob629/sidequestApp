...
class AppConfig {
  ...
  static const String _devServer = 'http://114.117.203.137:8081';
  static const String _devServer2 = 'http://1.14.75.127:8081';
  static const String _testServer = 'http://43.136.135.198:8081';
  static const String _prodServer = 'https://sidequestmeta.com';
  ...
  static const String noImage =
      "https://www.cabletiesandmore.com/images/gallery/no-image.jpg";

  static const String cityJson =
    ...
    if (env.contains("dev") || env.contains("test")) {
      ...
      if (action == ACTION_DEFAULT) {
        Stripe.publishableKey =
            "pk_test_51L1kPsBizrDMUWwg9A6jFjNOhdIDUtvUoMStTIv0RpfJx00EYC5fdICvH0UVyQM7mLBdt97T1GqU0P4mZbAVBQpj00mWsHoGvg";
      } else {
        Stripe.publishableKey =
            "pk_test_51M6DucBH03z3upvwgMfC6ipat2P4VacM6PY7m3Hl3t3KBgXwqxZwUNdKffZ6aPjMq0xPlTmLosOIVMS6DtjzCysZ006kJYlUA9";
      }
    } else {
      ...
      if (action == ACTION_DEFAULT) {
        Stripe.publishableKey =
            "pk_live_51L2yYXIXDgiM7OYZrSLG5cd2s9TQmlmNCMZjjIXporezDYxYrFuEziACkmsXOVVq6eAmXh4bykLcPov7xuFTAiKB00FUsm5xFM";
      } else {
        Stripe.publishableKey =
            "pk_live_51M2DJEB3wUGNV3o0sYDSmWc4taO50UAssHoZF962DboypII4XQFn1SyrwbIA3soc4V3MvLjXqotbUHPq2bHMxiOr00XzkcBdcO";
      }
    }
