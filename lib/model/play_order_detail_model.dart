...
class PlayOrderDetailModel {
  ...
  String reason = "";
  String playerRejectRefundReason = "";
  int receipttime = 0;
  ...
  PlayOrderDetailModel.fromJson(Map<String, dynamic> json) {
    ...
    tax = json['order']['tax'] ?? 0;
    status = json['order']['status'] ?? 0;
    statusArray = json['status'] == null
        ? []
        : (json['status'] as List).map((e) => StatusLable.fromJson(e)).toList();
    ...
    playerRejectRefundReason = json['order']['playerRejectRefundReason'] ?? "";
    receipttime = json['order']['receipttime'] ?? "";
    addtime = json['order']['addtime'] ?? "";
    discount = json['order']['discount'] ?? 0;
    acturalPayment = json['order']['acturalPayment'] ?? 0;
    profit = json['order']['profit'] ?? 0;
  }
}