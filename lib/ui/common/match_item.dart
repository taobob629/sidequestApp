            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      SvgPicture.asset("assets/images/ic_match_time.svg",
                      ...
                      Text(
                        "${'Time'.tr}: ${model.time}",
                        style:
                            TextStyle(color: Color(0xFF7C8AAD), fontSize: 12),
                      )
                    ],
                  ),
                  ...
                  Row(
                    children: [
                      SvgPicture.asset("assets/images/ic_match_location.svg",
                          color: Color(0xFF7D8AAC)),
                      SizedBox(
                        width: 10,
                        height: 8,
                  ...
                  Row(
                    children: [
                      SvgPicture.asset("assets/images/ic_match_o_people.svg",
                          width: 16, color: Color(0xFF7D8AAC)),
                      SizedBox(
                        width: 10,
                        height: 8,
                      ),
          ...
          Expanded(
            child: Stack(
              children: [
                ...
                Positioned(left: 36, child: _buildAvatar()),
                Positioned(left: 52, child: _buildAvatar()),
                Positioned(left: 68, child: _buildMore())
              ],
            ),
          ),
          Text(
            "4/12",
            style: TextStyle(color: Color(0xFF7D8AAC), fontSize: 12),
          )
        ],
      ),
    );
