                    ...
                    children: [
                      Stack(
                        children: [
                          Container(
                            ...
                            child: Stack(
                              ...
                              children: [
                                ...
                                Padding(
                                  padding:
                                      EdgeInsets.only(left: 20, bottom: 40.h),
                                  child: Column(
                                                              ...
                                                              BoxDecoration(
                                                                  ...
                                                                  gradient: LinearGradient(
                                                                      begin: Alignment
                                                                          ...
                                                                          .centerRight,
                                                                      colors: [
                                                                        if (userController.userProfile.gender ==
                                                                            0) ...[
                                                                          Color(
                                                                              0xFF1F84C9),
                                                                          Color(
                                                                              0xFF7CB9D5),
                                                                        ] else if (userController.userProfile.gender ==
                                                                            1) ...[
                                                                          Color(
                                                                              0xFFD57CAB),
                                                                          Color(
                          ...
                          Container(
                            margin:
                                EdgeInsets.only(left: 15, right: 15, top: 185)
                                    .r,
                            child: Column(
                              children: [
                                Container(
