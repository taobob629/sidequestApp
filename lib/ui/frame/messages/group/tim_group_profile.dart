...
class GroupProfile extends StatefulWidget {
  ...
  final MyGroupProfileWidgetBuilder? profileWidgetBuilder;

  /// [If you tend to customize the profile page, use [profileWidgetBuilder] with [profileWidgetsOrder] as priority.]
  /// If the default widget order can not meet you needs,
  /// you may change the order by this array with widget enum.
  final List<MyGroupProfileWidgetEnum>? profileWidgetsOrder;
...
class _TIMUIKitGroupProfileState extends TIMUIKitState<GroupProfile> {
  ...
  @override
  void didUpdateWidget(covariant GroupProfile oldWidget) {
  ...
  final List<MyGroupProfileWidgetEnum> _defaultWidgetOrder = [
    MyGroupProfileWidgetEnum.detailCard,
    MyGroupProfileWidgetEnum.operationDivider,
    MyGroupProfileWidgetEnum.memberListTile,
    MyGroupProfileWidgetEnum.operationDivider,
    MyGroupProfileWidgetEnum.searchMessage,
    MyGroupProfileWidgetEnum.operationDivider,
    MyGroupProfileWidgetEnum.groupNotice,
    MyGroupProfileWidgetEnum.groupManage,
   // MyGroupProfileWidgetEnum.groupJoiningModeBar,
   // MyGroupProfileWidgetEnum.groupTypeBar,
    MyGroupProfileWidgetEnum.operationDivider,
    MyGroupProfileWidgetEnum.pinedConversationBar,
    MyGroupProfileWidgetEnum.muteGroupMessageBar,
    MyGroupProfileWidgetEnum.operationDivider,
    MyGroupProfileWidgetEnum.nameCardBar,
    MyGroupProfileWidgetEnum.operationDivider,
    MyGroupProfileWidgetEnum.buttonArea
  ];
    ...
    return MultiProvider(
        ...
        builder: (context, w) {
          ...
          List<Widget> _renderWidgetsWithOrder(
              List<MyGroupProfileWidgetEnum> order) {
            final MyGroupProfileWidgetBuilder? customBuilder =
                widget.profileWidgetBuilder;
            return order.map((element) {
              switch (element) {
                case MyGroupProfileWidgetEnum.detailCard:
                ...
                case MyGroupProfileWidgetEnum.groupManage:
                ...
                case MyGroupProfileWidgetEnum.nameCardBar:
                ...
                case MyGroupProfileWidgetEnum.muteGroupMessageBar:
                ...
                case MyGroupProfileWidgetEnum.pinedConversationBar:
                ...
                case MyGroupProfileWidgetEnum.buttonArea:
                ...
                case MyGroupProfileWidgetEnum.customBuilderOne:
