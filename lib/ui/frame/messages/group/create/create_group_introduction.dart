...
class _CreateGroupIntroductionState extends State<CreateGroupIntroduction> {
  void createGroupFunc(GroupTypeForUIKit type) {
    Get.toNamed(AppPages.CreateGroup, arguments: Map()..['convType'] = type);
  }
  ...
  Widget renderGroupItem(String groupType) {
    return Container(
      decoration: BoxDecoration(
          border: Border.all(color: AppColor.background), borderRadius: BorderRadius.circular(10)),
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              Icon(Icons.group,
                  size: 40, color: CreateGroupIntroduction.groupTypeColorMap[groupType]!),
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              renderGroupItem(GroupType.AVChatRoom),
