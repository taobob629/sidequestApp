...
class PlaymateCtr extends GetxRefreshController<TopModel> {
  static PlaymateCtr get find => Get.find();
  ...
  Future<List<TopModel>> loadData({int pageNum = 1}) async {
    ...
    List<TopModel> list = [];
    showLoading();
    var response = await http.get('/peiwan/app/new/home/top/profit/players',
        queryParameters: ({
          'topNum': 20,
          'type': type,
          'pageNum': pageNum,
