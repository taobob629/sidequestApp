...
import 'package:sq_hub_app/ui/pages/home/popular_game_view.dart';
import 'package:sq_hub_app/ui/pages/home/support_game_view.dart';
...
class TabGamesPage extends StatelessWidget {
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    "Popular Games".tr,
                    style: TextStyle(
                        fontSize: 18, fontFamily: "din", color: Colors.white),
                  ),
                ),
                Image.asset(
                  "assets/images/ic_fire.webp",
                  height: 20,
                )
              ],
            )),
  ...
  List<Widget> _buildPopularList(List<GameModel> popularList) {
    ...
    for (int i = 0; i < popularList.length; i++) {
      ...
      list.add(PopularGameView(
        game: game,
        index: i + 1,
        last: i == popularList.length - 1,
      ));
    }
    return list;
  }
