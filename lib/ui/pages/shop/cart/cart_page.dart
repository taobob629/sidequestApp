...
import '../../profile/address/default_address.dart';
    ...
    return BaseScaffold(
        ...
        body: Stack(
          children: [
              ...
              child: SingleChildScrollView(
                  child: Obx(() => Column(
                        ...
                        children: [
                          ...
                          _buildFee("Delivery".tr, controller.shippingFee.value,
                              decoration: controller.shippingFee.value > 0
            ...
            Positioned(left: 0, right: 0, bottom: 0, child: PayButton())
          ],
        ));
  }
  ...
  Widget _buildAddress(BuildContext context) {
    return Padding(
        ...
        child: DefaultAddress(
          ...
          selectAddress: () =>
              userController.checkLogin(() => pageController.selectAddress()),
        ));
  }
            ...
            child: Row(
              ...
              children: [
                Text(
                  "Vouchers".tr,
                  style: TextStyle(
                      color: Colors.white, fontSize: 16, fontFamily: "DIN"),
                ),
                Icon(
      ...
      child: Row(
        ...
        children: [
          Text(
            title,
            style:
                TextStyle(color: Colors.white, fontSize: 16, fontFamily: "DIN"),
          ),
          Text(
            fee >= 0
                ...
                : "- £ ${(-fee).toStringAsFixed(2)}",
            style: TextStyle(
                color: Colors.white54, fontSize: 14, decoration: decoration),
          ),
        ],
      ),
    );
