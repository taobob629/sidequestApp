...
import '../../gift/my_gift_detail_page.dart';
import '../../order/detail/view.dart';
import '../../social/post/view/gift_suc_anim.dart';
import '../../social/post/view/give_gifts_dialog.dart';
import '../group/group_profile.dart';
    ...
    SmartDialog.show(
        builder: (builder) => Container(
            ...
            child: QrImage(
              ...
              data: jsonEncode({}..['gid'] = selectedConversation.groupID),
              size: 100.0,
            )),
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: Image.asset(
                    "assets/images/icon_${item.title.toLowerCase()}.webp",
                    width: 23.w,
                    height: 23.h,
                  ),
                ),
