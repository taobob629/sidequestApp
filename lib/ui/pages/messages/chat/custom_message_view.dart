...
class CustomMessageView extends StatelessWidget {
  ...
  Widget _postMsgItem() {
    return Container(
      ...
      decoration: BoxDecoration(
          color: AppColor.itemBg2, borderRadius: BorderRadius.circular(10)
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(data["action"],
                          style: TextStyle(
                              fontSize: 14.sp, color: AppColor.yellow)),
                    ],
                  ),
                ),
                7.verticalSpace,
                Text((int.tryParse(data["addtime"].toString()) ?? 0).toDateStr,
                    style:
                        TextStyle(fontSize: 12.sp, color: Color(0xFF808388))),
                8.verticalSpace,
                Container(
                  width: double.infinity,
                  padding:
  ...
  _inviteWidget() {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Image.asset(ImageUtils.group_invite, width: 115.w),
          20.verticalSpace,
  ...
  Widget _giftOrderWidget() => Container(
      width: width,
