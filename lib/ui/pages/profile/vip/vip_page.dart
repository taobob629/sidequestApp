...
import 'package:sq_hub_app/ui/pages/profile/vip/vip_info_dialog.dart';
                ...
                child: Obx(() {
                  return Container(
                    ...
                    child: Swiper(
                      ...
                      autoplay: false,
                      loop: false,
                      physics: const PagePhysics(parent: MyBouncingScrollPhysics()),
                        ...
                        return Container(
                          ...
                          child: Column(
                            children: [
                              contentPadding(
                                child: Image.asset(
                                  'assets/images/vip_level_$index.png',
                                ),
                              ),
                              Container(
                                child: Stack(
                                  ...
                                  children: [
                                    Positioned(
                                      child: Image.asset(
                                        "assets/images/vip_bg_${vipModel.level}.webp",
                                      ),
                                    ),
                                    Positioned(
                                      top: -10,
