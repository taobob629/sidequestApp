        ...
        child: Column(
          ...
          children: [
            ...
            InputView(
                ...
                label: "Nickname".tr,
                maxLength: 20,
                tips: "${userController.userProfile.nickName}"),
            InputView(
            ...
            InfoItem(
                title: "Birthday".tr,
                detail: "${userController.user.value.birth}"),
            InfoItem(
                title: "Account Email".tr,
                detail: "${userController.user.value.email}"),
            InfoItem(
                title: "Registered Date".tr,
                detail: "${userController.user.value.createTime}"),
            SizedBox(
              height: 50,
            )
          ],
...
class EditProfilePageController extends GetxController {
  ...
  EditProfilePageController() {
    birthday.value =
        DateFormat('dd/MM/y', 'en_GB').parse(userController.user.value.birth);
  }
  ...
  void updateInfo() async {
    ...
    if (avatar.value.path != "") {
      avatarUrl = await UserApi.uploadAvatar(
          avatar.value, (p0, p1) => print("$p0,$p1"));
    }

    String nick = nickController.text.isEmpty
    ...
    String firstName = fistController.text.isEmpty
        ? userController.user.value.firstName
        : fistController.text;
    String lastName = lastController.text.isEmpty
