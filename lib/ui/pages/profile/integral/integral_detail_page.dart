...
class IntegralDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => BaseScaffold(
    ...
    body: Obx(
      () =>
          ctr.integralGoodsDetailModel.value.name == null
              ? Container()
              : Container(
                  ...
                  child: Column(
                    children: [
                      CachedNetworkImage(
                        ...
                        errorWidget:
                            (c, m, e) => Image.asset(ImageUtils.default_logo),
                        height: 200.h,
                        width: 300.w,
                        fit: BoxFit.cover,
                      ),
                      ...
                      Container(
                        ...
                        margin: EdgeInsets.only(top: 10.h, bottom: 48.h),
                        padding: EdgeInsets.all(20.r),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
    ...
    floatingActionButton: ColorfulButton(
      ...
      onTap:
          () =>
              ctr.integralGoodsDetailModel.value.enoughPoint == true
                  ? Get.dialog(pointsPayWidget())
                  : Get.back(),
    ),
  );

  Widget infoWidget(String des) =>
      Platform.isAndroid
          ? Html(
            data: des,
            style: {"body": Style()},
                ...
                Text.rich(
                  TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: '${ctr.integralGoodsDetailModel.value.price} ',
                        style: TextStyle(
