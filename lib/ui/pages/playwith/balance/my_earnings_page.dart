...
import 'package:sq_hub_app/ui/pages/playwith/balance/play_balance_child.dart';
...
import '../../profile/bankcard/view.dart';
      ...
      Stack(
        children: [
          ...
          PWidget.container(
            PWidget.column([
              PWidget.row([
                PWidget.image(ImageUtils.ic_balance_votes),
                PWidget.boxw(6),
