...
class AttentionTabPage extends GetView<AttentionTabController> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TabBarView(
        controller: controller.tabController,
        children: [
          KeepAliveWrapper(child: AttentionUserListPage(TYPE_FOLLOW)),
          KeepAliveWrapper(child: AttentionUserListPage(TYPE_FANS)),
        ],
      ),
    );
  }
