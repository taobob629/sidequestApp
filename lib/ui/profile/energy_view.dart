...
class EnergyView extends StatelessWidget {
  ...
  EnergyView({required this.percent,required this.remaining}){
    if(remaining >= 60){
  ...
  Widget _buildEnergy(bool full){
    return Container(
      ...
      child: Stack(
        children: [
          Image.asset("assets/images/energy_empty.webp",fit: BoxFit.contain,),
          full?Image.asset("assets/images/energy_full.webp",fit: BoxFit.contain,):Container()
        ],
      ),
    );
  }
