...
class MyConsumePage extends StatelessWidget {
  ...
  List<Widget> createPages() {
    List<Widget> pages = [];
    pages.add(KeepAliveWrapper(child: TabConsumePage(type: 1,)));
    pages.add(KeepAliveWrapper(child: TabConsumePage(type: 2,)));
    pages.add(KeepAliveWrapper(child: TabConsumePage(type: 3,)));
    return pages;
  }
}
