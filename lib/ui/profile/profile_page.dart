        ...
        Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [Color(0xFFFC3C02),Color(0xFF171525)]
            )
          ),
        ),
        Scaffold(
              ...
              SliverAppBar(
                ...
                actions: [
                  ...
                  Badge(
                    ...
                    badgeContent: null,
                    child: ActionButton(
                      onTap: ()=>userController.checkLogin(()=>Get.to(()=>NotificationPage())),
                      icon: Image.asset("assets/images/ic_msg_new.webp",width: 26)
                    ),
                  ),
                  SizedBox(width: 0,),
                  ActionButton(
                    onTap: ()=>userController.checkLogin(()=>Get.to(()=>SettingsPage())),
                    icon: Image.asset("assets/images/ic_setting_new.webp",width: 24,height: 24,fit: BoxFit.contain,)
                  ),
                  SizedBox(width: 0,),
                ],
                floating: true,
