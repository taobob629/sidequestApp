...
These terms of use which include our privacy policy (link here to privacy policy) and cookie policy (link to cookie policy).
...
Personally, identifying information is subject to our Privacy Policy https://sidequesthub.com/privacy, the terms of which are incorporated herein. Please review our Privacy Policy to understand our practices.
...
You must be at least 16 years of age to become a member of the SideQuest VIP service. Those under the required age may only have access to the base membership.
...
Your SideQuest monthly benefits reset on a monthly basis and do not accrue those benefits are hours on SideQuest equipment and bubble teas.
...
''';
  ...
  Widget build(BuildContext context) {
    ...
    return WyDialog(
      ...
      child: Column(
        children: <Widget>[
          Text("VIP Upgrade Terms & Conditions",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.white),),
          SizedBox(height: 10,),
          Expanded(
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Text(tips1,style: TextStyle(fontSize: 14,color: Colors.white),),
                  Text(tips2,style: TextStyle(fontSize: 14,color: Colors.red),),
                  Text(tips3,style: TextStyle(fontSize: 14,color: Colors.white),),
                ],
              )
            ),
          ),
