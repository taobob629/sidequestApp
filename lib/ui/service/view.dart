...
import '../frame/sidekick/controller.dart';
...
class MoreGamesPage extends GetView<MoreGamesPageController> {
  ...
  Widget build(BuildContext context) {
    ...
    return ShowCaseWidget(
      ...
      onFinish: () => StorageManager.setBoolValue('backKey', true),
      builder: Builder(
        builder: (builder) {
          myContext = builder;
          return Scaffold(
            appBar: AppBar(
              ...
              leading: Showcase(
                overlayOpacity: 0,
                key: GlobalKeyConstants.backKey,
                description: 'Please click the back button after add'.tr,
