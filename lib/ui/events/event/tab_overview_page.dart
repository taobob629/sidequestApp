...
class TabOverviewPage extends StatelessWidget {
    ...
    return Obx(()=>Container(
      ...
      child: Column(
        children: [
          ...
          _buildSectionTopItem("fee","Price","£ ${controller.eventDetailModel.value.fee}",align: CrossAxisAlignment.start,),
  ...
  Widget _buildSectionTopItem(String iconName, String title, String content,
    {CrossAxisAlignment align = CrossAxisAlignment.center, double width = 20,double height = 20}){
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 15,vertical: 11),
      child: Row(
        crossAxisAlignment: align,
        children: [
          SvgPicture.asset("assets/images/ic_match_o_$iconName.svg",color: Color(0xFF7D8AAC),width: width,height: height,),
          Padding(
            padding: const EdgeInsets.only(left: 10,top: 4),
            child: Text(title,style: TextStyle(color: Colors.white,fontFamily: "DIN",fontSize: 16),),
          ),
          Spacer(),
          Padding(
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text("GENERAL INFORMATION",style: TextStyle(color: Colors.white,fontFamily: "DIN",fontSize: 16),),
          ),
          Html(
