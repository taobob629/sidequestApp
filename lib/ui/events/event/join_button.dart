...
class JoinButton extends StatelessWidget {
  ...
  final EventPageController eventPageController = Get.find<EventPageController>();
              ...
              onTap: ()=>userController.checkLogin(
                  ()=>Get.to(
                      ()=>JoinTeamPage(
                        ...
                        create:false,
                        banner: eventDetailModel.listImage.isEmpty ? eventDetailModel.image : eventDetailModel.listImage,
                        location: [],
                      )
                  )
              ),
        ...
        children: [
          ...
          Material(
            ...
            child: Ink(
              child: InkWell(
                onTap: ()=>userController.checkLogin(
                    ()=>eventPageController.checkFee(()=>Get.to(
                        ()=>JoinTeamPage(
                        id:eventDetailModel.id,
                        create:true,
